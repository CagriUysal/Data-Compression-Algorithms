function [comp, compression_rate] = binary_huffman(text_file)
...
[dict, avglen] = huffmandict(C, char_prob); % find huffman dictionary
...
fileID = fopen('./results/binary_huffman_results.txt', 'w');

% (probability - 'char' - binary_code) 
